...
urlpatterns += [
  ...
  path("target-datasets/<int:pk>/architecture-review/report/", views.targetdataset_architecture_report, name="targetdataset_architecture_report"),
  path("target-datasets/<int:pk>/architecture-review/report/download/", views.targetdataset_architecture_report_download, name="targetdataset_architecture_report_download"),
  path("target-datasets/<int:pk>/architecture-review/approve/", views.targetdataset_architecture_approve, name="targetdataset_architecture_approve"),
  path("target-datasets/<int:pk>/architecture-review/check/", views.targetdataset_architecture_approval_check, name="targetdataset_architecture_approval_check"),
  ...
  path("metadata/queryunionnode/<int:parent_pk>/output-columns/copy-schema/", views.queryunion_copy_output_schema_from_branch, name="queryunionoutputcolumn_copy_schema"),
  path("metadata/queryunionnode/<int:parent_pk>/validate/", views.queryunion_validate, name="queryunion_validate"),
  path("metadata/queryunionnode/<int:parent_pk>/set-head/", views.queryunion_set_as_head, name="queryunion_set_as_head"),
  path("metadata/queryunionbranch/<int:parent_pk>/mappings/auto-map/", views.queryunionbranch_automap_by_name, name="queryunionbranch_automap_by_name"),
