    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('source_column', models.CharField(help_text="Original source column name, eg. 'MANDT', 'VBELN'.", max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('short_name', models.CharField(help_text="Physical / concrete system identifier. eg. 'sap', 'nav', 'crm', 'ga4'.", max_length=10, unique=True, validators=[django.core.validators.RegexValidator(message='Must start with a lowercase letter and contain only lowercase letters and digits. Max length is 10 characters.', regex='^[a-z][a-z0-9]{0,9}$')])),
                ('name', models.CharField(help_text='Identifying name of the source system. Does not have technical consequences.', max_length=50)),
                ('description', models.CharField(blank=True, help_text='Business description / semantic meaning of the source system.', max_length=255, null=True)),
                ('type', models.CharField(choices=[('redshift', 'Amazon Redshift'), ('s3', 'Amazon S3 Storage (manual, no reflection)'), ('azureblob', 'Azure Blob Storage (manual, no reflection)'), ('csv', 'CSV File(s) (manual, no reflection)'), ('clickhouse', 'ClickHouse (beta, limited reflection)'), ('databricks', 'Databricks SQL'), ('duckdb', 'DuckDB'), ('exasol', 'Exasol (manual, no reflection)'), ('excel', 'Excel / XLSX File(s) (manual, no reflection)'), ('bigquery', 'Google BigQuery'), ('gcs', 'Google Cloud Storage (manual, no reflection)'), ('graphql', 'GraphQL API (manual, no reflection)'), ('db2', 'IBM DB2 (manual, no reflection)'), ('json', 'JSON File(s) (manual, no reflection)'), ('jsonl', 'JSON Lines File(s) (manual, no reflection)'), ('mysql', 'MySQL / MariaDB'), ('oracle', 'Oracle'), ('parquet', 'Parquet File(s) (manual, no reflection)'), ('postgresql', 'PostgreSQL'), ('presto', 'Presto (beta, limited reflection)'), ('rest', 'REST API (manual, no reflection)'), ('hana', 'SAP HANA (manual, no reflection)'), ('sapr3', 'SAP R/3 (manual, no reflection)'), ('sftp', 'SFTP Location (manual, no reflection)'), ('mssql', 'SQL Server'), ('sqlite', 'SQLite'), ('snowflake', 'Snowflake'), ('teradata', 'Teradata (manual, no reflection)'), ('trino', 'Trino (beta, limited reflection)')], help_text='System type / backend technology. Used for import and adapter logic.', max_length=20)),
                ('target_short_name', models.CharField(help_text="Stable business prefix for stage/rawcore naming (e.g. 'sap', 'crm', 'fi').", max_length=10, validators=[django.core.validators.RegexValidator(message='Must start with a lowercase letter and contain only lowercase letters and digits. Max length is 10 characters.', regex='^[a-z][a-z0-9]{0,9}$')])),
                ('include_ingest', models.CharField(choices=[('none', 'None'), ('external', 'External'), ('native', 'Native')], default='none', help_text='How/if this source participates in ingestion pipelines. If None, it is expected that the data are delivered through an alternative way.', max_length=20)),
                ('generate_raw_tables', models.BooleanField(default=False, help_text="Default policy: create raw landing tables (TargetDatasets in schema 'raw') for all SourceDatasets in this SourceSystem.")),
                ('active', models.BooleanField(default=True, help_text='System is still considered a live data source.')),
        ...
        migrations.AddField(
            model_name='sourcedataset',
            name='source_system',
            field=models.ForeignKey(help_text='The source system this dataset comes from.', on_delete=django.db.models.deletion.CASCADE, related_name='source_tables', to='metadata.sourcesystem'),
        ),
        migrations.CreateModel(
            name='TargetColumn',
            fields=[
                ...
                ('business_key_column', models.BooleanField(default=False, help_text='If checked, this column is part of the logical/business key.')),
                ('surrogate_key_column', models.BooleanField(default=False, help_text='If checked, this column is the system-generated surrogate key.')),
                ...
                ('manual_expression', models.TextField(blank=True, help_text="Default platform-neutral expression (elevata DSL) for deriving this column. Example: {{ UPPER(customer_name) }}, {{ DATE_ADD('day', order_date, 7) }}, {{ COALESCE(a, b, 'fallback') }}. This applies to all inputs unless overridden at source level.", null=True)),
                ('description', models.CharField(blank=True, help_text='Business description / semantic meaning of the column.', max_length=255, null=True)),
                ('pii_level', models.CharField(choices=[('none', 'No personal data'), ('personal_data', 'Personal data'), ('special_category_data', 'Special category personal data')], default='none', help_text='PII classification of this column, if applicable.', max_length=30)),
                ('remark', models.CharField(blank=True, help_text='Free-form notes.', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('manual_expression', models.TextField(blank=True, help_text='Optional platform-neutral expression (elevata DSL) that applies ONLY when using this specific source column. If empty, the TargetColumn.manual_expression is used.', null=True)),
                ...
                ('source_column', models.ForeignKey(help_text='The specific source column feeding this target column.', on_delete=django.db.models.deletion.PROTECT, related_name='output_links', to='metadata.sourcecolumn')),
        ...
        migrations.AddField(
            ...
            name='source_columns',
            field=models.ManyToManyField(blank=True, help_text='Which source columns contribute to this target column.', related_name='mapped_target_columns', through='metadata.TargetColumnInput', to='metadata.sourcecolumn'),
        ),
        migrations.CreateModel(
            name='TargetDataset',
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('derived_from', models.ManyToManyField(blank=True, help_text='Upstream TargetDatasets that conceptually feed this dataset (e.g. rawcore entity tables feeding this bizcore table).', related_name='downstream_derivations', to='metadata.targetdataset')),
        ...
        migrations.CreateModel(
            name='IncrementFieldMap',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True, db_index=True)),
                ('source_field_name', models.CharField(help_text="Field name as it appears in the source dataset's increment_filter (e.g. 'last_update_ts', 'created_at', 'is_deleted_flag').", max_length=100)),
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('target_column', models.ForeignKey(help_text='Column in this TargetDataset that semantically corresponds to that source field.', on_delete=django.db.models.deletion.CASCADE, related_name='used_for_incremental_filter', to='metadata.targetcolumn')),
                ('target_dataset', models.ForeignKey(help_text='The core/target dataset that consumes this mapping.', on_delete=django.db.models.deletion.CASCADE, related_name='incremental_field_mappings', to='metadata.targetdataset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('integration_mode', models.CharField(blank=True, help_text="How this source is integrated: 'union_all', 'merge_on_keys', 'lookup_enrichment', etc.", max_length=20, null=True)),
                ...
                ('created_by', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('source_dataset', models.ForeignKey(help_text='The source dataset contributing to this target dataset.', on_delete=django.db.models.deletion.CASCADE, related_name='output_links', to='metadata.sourcedataset')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, help_text='Which source datasets feed this target dataset. Used for multi-source consolidation, staging, rawcore integration, etc.', related_name='target_datasets', through='metadata.TargetDatasetInput', to='metadata.sourcedataset'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('source_dataset', 'source_column'), name='unique_source_column'),
        ),
        migrations.AddConstraint(
            model_name='sourcecolumn',
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('target_column', 'source_column'), name='unique_target_column_input_source'),
        ),
        migrations.AddConstraint(
            model_name='targetcolumn',
        ...
        migrations.AddConstraint(
            model_name='incrementfieldmap',
            constraint=models.UniqueConstraint(fields=('target_dataset', 'source_field_name'), name='unique_incremental_field_mapping_per_target'),
        ),
        migrations.AddConstraint(
            model_name='targetdatasetinput',
            constraint=models.UniqueConstraint(fields=('target_dataset', 'source_dataset'), name='unique_source_per_target_dataset'),
        ),
        migrations.AddConstraint(
