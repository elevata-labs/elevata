...
def get_available_dialect_names() -> list[str]:
  """Return a sorted list of registered SQL dialect names."""
  return sorted(_DIALECT_REGISTRY.keys())


def get_active_dialect_name(name: Optional[str] = None) -> str:
  """
  Return the resolved dialect name using the same resolution logic as
