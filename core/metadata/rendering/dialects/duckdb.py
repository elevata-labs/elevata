...
class DuckDBDialect(SqlDialect):
  ...
  def render_alter_column_type(
    ...
    *,
    ...
    """
    Render DuckDB DDL for changing a column's physical type.

    old_type is accepted to match the base dialect contract. DuckDB does not
    need it for this SQL shape.
    """
